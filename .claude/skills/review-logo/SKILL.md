---
name: review-logo
description: Review logo designs and provide detailed feedback on visual design, branding, and improvements for the IronPal body-mounted camera product
---
...
3. **For each logo image**, provide specific, actionable feedback on:
   ...
   ### Iconography
   - For Logo 1 (Iron Ring): Is the lens dot at exactly 12 o'clock? Is it ~12% of ring diameter? Is the ring gap at ~70 degrees? Is the stroke weight 18-20% of diameter?
