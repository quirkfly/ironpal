...
| S5 | Athlete on bench looking at phone with app | "Photorealistic cinematic medium shot of an athletic male sitting upright on a gym bench after finishing a workout, slight sweat on forehead, matte black headband with teal LED and teal 'IronPal' text clearly visible pulled down around his neck, towel draped over one shoulder, holding a smartphone in one hand at chest height angled toward camera, looking at the screen with a relaxed impressed smile, warm amber gym lighting, shallow depth of field with gym equipment softly blurred in background, 50mm lens, IronPal logo prominently placed on the headband in a clean modern font, consistent teal brand color" | Payoff moment — logo and 'IronPal' text clearly visible on headband to reinforce brand identity. **Keep the phone screen generic/blank in the AI generation — do NOT describe app UI details in this prompt.** The workout log screen is composited onto the phone in post from the Figma mockup (same pattern as S1/S2a/S2b). |
| S6a | Social proof — diverse athlete 1 | "Athletic female wearing matte black headband with teal LED glowing and teal 'IronPal' text clearly visible on the side, mid-exercise performing kettlebell swings in a modern brightly-lit gym, warm lighting, cinematic, focused and determined expression, IronPal logo prominently placed on the headband in a clean modern font, consistent teal brand color" | Quick montage — logo and 'IronPal' text clearly visible on headband to reinforce brand identity |
| S6b | Social proof — diverse athlete 2 | "Athletic male wearing matte black baseball cap with teal LED glowing and teal 'IronPal' text clearly visible on the front, mid-exercise performing pull-ups in a gritty industrial gym, warm lighting, cinematic, focused and intense expression, IronPal logo prominently placed on the cap in a clean modern font, consistent teal brand color" | Quick montage — logo and 'IronPal' text clearly visible on cap to reinforce brand identity |
| S6c | Social proof — diverse athlete 3 | "Athletic female wearing matte black headband with teal LED glowing and teal 'IronPal' text clearly visible on the side, mid-exercise performing box jumps in a bright CrossFit-style gym, warm lighting, cinematic, focused and explosive expression, IronPal logo prominently placed on the headband in a clean modern font, consistent teal brand color" | Quick montage — logo and 'IronPal' text clearly visible on headband to reinforce brand identity |
| S7 | End card product shot | "IronPal matte black headband and baseball cap with teal accents and teal 'IronPal' text clearly visible on both products laid on dark slate surface, small camera module between them with glowing teal LED, 'IronPal' logo in clean modern teal font prominently displayed on headband side and cap front, dramatic side lighting, product photography, dark background, consistent teal brand color across all elements" | Final beauty shot — logo and 'IronPal' text clearly visible on both products for maximum brand recognition |
